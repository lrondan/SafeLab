...
urlpatterns = [
    ...
    path('lab/<int:lab_id>/process_trainer/new', views.process_trainer_create, name='process_trainer_create'),
    path('processtrainer/<int:process_trainer_id>/edit/', views.process_trainer_update, name="process_trainer_update"),
    path('processtrainer/<int:process_trainer_id>/delete/', views.process_trainer_delete, name="process_trainer_delete"),
